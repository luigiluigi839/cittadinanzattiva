...
('SUGGERIMENTO','Vogliamo il palio quest anno',1,'risolto',NULL,'Servizi Culturali',2,5,'via G. Amendola',22,26086),
('RECLAMO','Bisogna tagliare l erba',2,NULL,NULL,'Verde Pubblico',8,2,'via San pio X',158,26012);
